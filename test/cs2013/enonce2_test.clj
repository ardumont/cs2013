...
(def big-input-for-test
  [{:VOL "resonant-unit-62"            :DEPART 0   :DUREE 4 :PRIX 15}
   ...
   {:VOL "enchanting-pillowcase-66"    :DEPART 170 :DUREE 4 :PRIX 9}
   ...
   {:VOL "confused-sterilization-85"   :DEPART 250 :DUREE 2 :PRIX 28}])
...
(fact
  (children-sup 0 [{:DEPART 0 :DUREE 5}
                   {:DEPART 3 :DUREE 3}
                   {:DEPART 5 :DUREE 9}
                   {:DEPART 6 :DUREE 10}
                   {:DEPART 5 :DUREE 9}]) => '({:DUREE 5 :DEPART 0}
                                               {:DUREE 3 :DEPART 3}
                                               {:DUREE 9 :DEPART 5}
                                               {:DUREE 10 :DEPART 6}
                                               {:DUREE 9 :DEPART 5})
  (children-sup 2 [{:DEPART 0 :DUREE 5}
                   {:DEPART 3 :DUREE 3}
                   {:DEPART 5 :DUREE 9}
                   {:DEPART 6 :DUREE 10}
                   {:DEPART 5 :DUREE 9}]) => '({:DUREE 3 :DEPART 3}
                                               {:DUREE 9 :DEPART 5}
                                               {:DUREE 10 :DEPART 6}
                                               {:DUREE 9 :DEPART 5})
  (children-sup 3 [{:DEPART 0 :DUREE 5}
                   {:DEPART 3 :DUREE 3}
                   {:DEPART 5 :DUREE 9}
                   {:DEPART 6 :DUREE 10}
                   {:DEPART 5 :DUREE 9}]) => '({:DUREE 3 :DEPART 3}
  ...
  (children-sup 20 [{:DEPART 0 :DUREE 5}
                    {:DEPART 3 :DUREE 3}
                    {:DEPART 5 :DUREE 9}
                    {:DEPART 6 :DUREE 10}
                    {:DEPART 5 :DUREE 9}]) => ())
