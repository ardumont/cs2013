...
(fact "Compute all the nodes and group them by identity"
  (nodes [{:VOL "META18"   :DEPART 3 :DUREE 7 :PRIX 14}
...
(fact "adjacent list of nodes"
  (adjacent-nodes [{:VOL "META18"   :DEPART 3 :DUREE 7 :PRIX 14}
                   {:VOL "LEGACY01" :DEPART 5 :DUREE 9 :PRIX 8}
                   {:VOL "MONAD42"  :DEPART 0 :DUREE 5 :PRIX 10}
                   {:VOL "YAGNI17"  :DEPART 5 :DUREE 9 :PRIX 7}]) => {"META18" ()
                                                                      "LEGACY01" ()
                                                                      "MONAD42" ["LEGACY01" "YAGNI17"],
                                                                      "YAGNI17" ()}

  (adjacent-nodes [{:VOL "META18"   :DEPART 3 :DUREE 1 :PRIX 14}
                   {:VOL "LEGACY01" :DEPART 5 :DUREE 9 :PRIX 8}
                   {:VOL "LEGACY11" :DEPART 5 :DUREE 9 :PRIX 13}
                   {:VOL "MONAD42"  :DEPART 0 :DUREE 1 :PRIX 10}
                   {:VOL "YAGNI17"  :DEPART 5 :DUREE 9 :PRIX 7}]) => {"YAGNI17" ()
                                                                      "MONAD42" ["META18"
                                                                                 "LEGACY01"
                                                                                 "LEGACY11"
                                                                                 "YAGNI17"],
