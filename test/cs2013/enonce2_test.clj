...
(fact "Compute all the nodes and group them by identity"
  (adjacents [{:VOL "META18"   :DEPART 3 :DUREE 7 :PRIX 14}
              {:VOL "LEGACY01" :DEPART 5 :DUREE 9 :PRIX 8}
              {:VOL "MONAD42"  :DEPART 0 :DUREE 5 :PRIX 10}
              {:VOL "YAGNI17"  :DEPART 5 :DUREE 9 :PRIX 7}]) => {{:VOL "META18"   :DEPART 3 :DUREE 7 :PRIX 14} ()
                                                                 {:VOL "LEGACY01" :DEPART 5 :DUREE 9 :PRIX 8} ()
...
(fact "Simple - Build a tree from a starting point."
  (build-tree {{:VOL "META18"   :DEPART 3 :DUREE 7 :PRIX 14} ()
               ...
               {:VOL "YAGNI17"  :DEPART 5 :DUREE 9 :PRIX 7} ()}
              {:VOL "MONAD42"  :DEPART 0 :DUREE 5 :PRIX 10})
  => '({:gain 10 :path ["MONAD42"] :id {:DUREE 5 :PRIX 10 :VOL "MONAD42" :DEPART 0}}
       {:id {:DUREE 9 :PRIX 8 :VOL "LEGACY01" :DEPART 5} :gain 18 :path ["MONAD42" "LEGACY01"]}
       {:id {:DUREE 9 :PRIX 7 :VOL "YAGNI17" :DEPART 5} :gain 17 :path ["MONAD42" "YAGNI17"]}))
...
(fact
  (optimize [{:VOL "resonant-unit-62"            :DEPART 0   :DUREE 4 :PRIX 15}
             ...
             {:VOL "hollow-photography-8"        :DEPART 24  :DUREE 5 :PRIX 12}]) => {:path ["resonant-unit-62"
    ...
    (optimize [{:VOL "tame-outfielder-60"        :DEPART 2  :DUREE 7  :PRIX 24}
               ...
               {:VOL "frightened-sucker-75"      :DEPART 54 :DUREE 6  :PRIX 1}]) => {:gain 178
                                                                                   :path ["tame-outfielder-60"
                                                                                          "weary-industry-57"
                                                                                          "hungry-castle-19"
                                                                                          "thoughtful-keyhole-17"
                                                                                          "testy-seat-36"
                                                                                          "tiny-sixshooter-30"
                                                                                          "excited-raffle-94"
                                                                                          "busy-wrench-13"
                                                                                          "cooing-granola-52"
                                                                                          "impossible-supervisor-37"
                                                                                          "defeated-shopkeeper-62"
                                                                                          "bloody-fridge-53"
                                                                                          "low-swordfish-76"
                                                                                          "lucky-sweatshop-68"]}))
