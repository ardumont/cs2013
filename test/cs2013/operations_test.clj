...
(fact
  ...
  (compute-infix-operation-from-string "((1,1+2)+3,14+4+(5+6+7)+(8+9+10)*4267387833344334647677634)/2*553344300034334349999000") => 3.18780189038289E49)
...
(fact
  ...
  (eval-ast '(((((((1.1 + 2) + 3.14) + 4) + ((5 + 6) + 7)) + (((8 + 9) + 10) * 4267387833344334647677634N)) / 2) * 553344300034334349999000N)) => 3.18780189038289E49)
