...
get the app created:
    ...
    $ heroku apps:create cs2013
    Creating cs2013... done, stack is cedar
    http://cs2013.herokuapp.com/ | git@heroku.com:cs2013.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://cs2013.herokuapp.com deployed to Heroku

    To git@heroku.com:cs2013.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://cs2013.herokuap.com
    ["Hello" :from Heroku]
