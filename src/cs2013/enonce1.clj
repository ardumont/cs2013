...
;; Pour faire face a l'afflux de touristes etrangers avec les poches remplies de groDessimaux, vous avez besoin d'ecrire un programme qui pour toute somme de 1 a 100 cents
;; , vous donnera toutes les decompositions possibles en pieces de **Foo**, **Bar**, **Qix** ou **Baz**.
